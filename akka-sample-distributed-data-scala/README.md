This tutorial contains 5 samples illustrating how to use [Akka Distributed Data](http://doc.akka.io/docs/akka/2.5.0/scala/distributed-data.html).
...
The counters are kept in a [PNCounterMap](http://doc.akka.io/docs/akka/2.5.0/scala/distributed-data.html#Counters)and updated with:
...
Read the [Using the Replicator](http://doc.akka.io/docs/akka/2.5.0/scala/distributed-data.html#Using_the_Replicator)documentation for more details of how to use `Get`, `Update`, and `Subscribe`.
...
Each product in the cart is represented by a `LineItem` and all items in the cart is collected in a [LWWMap](http://doc.akka.io/docs/akka/2.5.0/scala/distributed-data.html#Maps).
...
Read the [Consistency](http://doc.akka.io/docs/akka/2.5.0/scala/distributed-data.html#Consistency) section in the documentation to understand the consistency considerations.
