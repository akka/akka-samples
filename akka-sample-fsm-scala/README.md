...
Read more about `become` in [the documentation](http://doc.akka.io/docs/akka/2.6/scala/actors.html#Become_Unbecome).
...
Read more about `akka.actor.FSM` in [the documentation](http://doc.akka.io/docs/akka/2.6/scala/fsm.html).
