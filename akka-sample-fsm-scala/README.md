...
Read more about `become` in [the documentation](http://doc.akka.io/docs/akka/current/scala/actors.html#Become_Unbecome).
...
Read more about `akka.actor.FSM` in [the documentation](http://doc.akka.io/docs/akka/current/scala/fsm.html).
