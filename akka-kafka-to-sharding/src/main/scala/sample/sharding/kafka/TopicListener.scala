...
object TopicListener {
  def apply(typeKey: EntityTypeKey[_], partitionToShard: Int => String = _.toString): Behavior[ConsumerRebalanceEvent] = Behaviors.setup { ctx =>
    // TODO, untyped extension, should we create a typed extension that takes in an entitykey?
